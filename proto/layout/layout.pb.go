...
/*
Package browser_layout is a generated protocol buffer package.
...
const (
	Units_PIXEL   UnitsType = 0
	Units_PERCENT UnitsType = 1
)

var UnitsType_name = map[int32]string{
	0: "PIXEL",
	1: "PERCENT",
}
var UnitsType_value = map[string]int32{
	"PIXEL":   0,
	"PERCENT": 1,
}

func (x UnitsType) String() string {
	return proto.EnumName(UnitsType_name, int32(x))
}
func (UnitsType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }

type ColorType int32

const (
	Color_HEX  ColorType = 0
	Color_RGBA ColorType = 1
)
...
func (ColorType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
type Grid struct {
	...
	Rows     []*Grid    `protobuf:"bytes,3,rep,name=rows" json:"rows,omitempty"`
	Columns  []*Grid    `protobuf:"bytes,4,rep,name=columns" json:"columns,omitempty"`
...
func (*Grid) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func init() {
	proto.RegisterType((*Units)(nil), "browser.layout.Units")
	proto.RegisterType((*Color)(nil), "browser.layout.Color")
	proto.RegisterType((*Function)(nil), "browser.layout.Function")
	proto.RegisterType((*Area)(nil), "browser.layout.Area")
	proto.RegisterType((*Events)(nil), "browser.layout.Events")
	proto.RegisterType((*Square)(nil), "browser.layout.Square")
	proto.RegisterType((*Text)(nil), "browser.layout.Text")
	proto.RegisterType((*TextBox)(nil), "browser.layout.TextBox")
	proto.RegisterType((*Button)(nil), "browser.layout.Button")
	proto.RegisterType((*Image)(nil), "browser.layout.Image")
	proto.RegisterType((*Element)(nil), "browser.layout.Element")
	proto.RegisterType((*Grid)(nil), "browser.layout.Grid")
	proto.RegisterEnum("browser.layout.UnitsType", UnitsType_name, UnitsType_value)
	proto.RegisterEnum("browser.layout.ColorType", ColorType_name, ColorType_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
